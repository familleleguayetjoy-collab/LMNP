...
def traiter_dossier(factures, ops_banque, dico, *, client_ia=None, resolver=None,
    ...
    if avec_banque:
        ...
        # `seulement_payees` : avec un relevé, une facture qui ne se déclare pas
        # payée et qu'on n'y retrouve pas n'a pas été réglée. Pas de flux, pas
        # d'écriture — elle reste ouverte pour l'exercice où elle le sera.
        od_ops = operations_od_factures(orphelines, dico, resolver,
                                        seulement_payees=True)
